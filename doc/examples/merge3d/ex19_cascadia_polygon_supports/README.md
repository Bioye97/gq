# ex19_cascadia_polygon_supports

This high-taper example repeats `ex15_cascadia_polygon_supports`, using 0.49
on every side except the beginning of the z axis, which remains zero.
...
```text
SVI_EQTOMO      WUS324 svi_star.txt       - cosine/cosine/cosine 0.49/0.49/0.49/0.49/0/0.49
Cascadia_ANT+RF WUS324 ant_triangle.txt   - cosine/cosine/cosine 0.49/0.49/0.49/0.49/0/0.49
WUS324          -      -                  - -                    -
```
...
```bash
./ex19_cascadia_polygon_supports.sh
```
...
- `ex19_cascadia_polygon_supports_horizontal.png` and
  `ex19_cascadia_polygon_supports_horizontal.pdf`
- `ex19_cascadia_polygon_supports_vertical.png` and
  `ex19_cascadia_polygon_supports_vertical.pdf`
