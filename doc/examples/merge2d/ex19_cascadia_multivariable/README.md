# ex19_cascadia_multivariable

This high-taper example repeats `ex15_cascadia_multivariable` with taper
ratios of 0.49.
...
windows with taper ratios of 0.49. The figure compares tiling and aggregate
...
```bash
./ex19_cascadia_multivariable.sh
```

The script creates:

```text
ex19_cascadia_vp_vs.png
ex19_cascadia_vp_vs.pdf
ex19_cascadia_vp_vs_density.png
ex19_cascadia_vp_vs_density.pdf
```
