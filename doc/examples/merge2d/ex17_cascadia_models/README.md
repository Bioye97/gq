# ex17_cascadia_models

This high-taper example repeats `ex13_cascadia_models` with taper ratios of
0.49.
...
```text
SVI_EQTOMO WUS324 - cosine/cosine 0.49
Cascadia_ANT+RF WUS324 - cosine/cosine 0.49
WUS324 - - - -
```
...
```text
SVI_EQTOMO WUS324 - cosine/cosine 0.49
Cascadia_v1.6 WUS324 - cosine/cosine 0.49
WUS324 - - - -
```
...
taper ratios of 0.49. Solid black lines in panel (a) outline the two primary
...
```bash
./ex17_cascadia_models.sh
```

The script creates:

```text
ex17_cascadia_ant_rf.png
ex17_cascadia_ant_rf.pdf
ex17_cascadia_v16.png
ex17_cascadia_v16.pdf
```
